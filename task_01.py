...
def get_graf(is_weigted=False):
    ...
    if is_weigted:
        G.add_weighted_edges_from([
            ('Залізничний вокзал', 'Привоз',1),
            ('Залізничний вокзал', 'Парк Шевченка', 3),
            ('Залізничний вокзал', 'Площа Толбухіна', 4),
            ('Привоз', 'Міський сад', 2),
            ('Привоз', 'Вул. Пастера', 3),
            ('Парк Шевченка', 'Оперний театр', 2),
            ('Площа Толбухіна', 'Центральний автовокзал', 6),
            ('Міський сад', 'Аркадія', 6),
            ('Міський сад', 'Оперний театр', 1),
            ('Оперний театр', 'Вул. Дерибасівська', 1),
            ('Вул. Пастера', 'Центральний автовокзал', 3),
            ('Аркадія', 'Центральний автовокзал', 5),
            ('Аркадія', 'Фонтанська дорога', 3),
